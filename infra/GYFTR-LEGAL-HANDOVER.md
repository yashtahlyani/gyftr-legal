...
For production, avoid exposing application port 7978 directly to the public internet. Restrict it so that the backend receives traffic through the Application Load Balancer.
...
- Target group uses port 7978 with health check path `/health`.
